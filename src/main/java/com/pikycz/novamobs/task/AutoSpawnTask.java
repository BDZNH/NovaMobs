...
import com.pikycz.novamobs.FileLogger;
...
public class AutoSpawnTask extends TimerTask {
    ...
    private void prepareMaxSpawns() {
        ...
        FileLogger.debug(String.format(
                ...
                maxSpawns.get(Horse.NETWORK_ID),maxSpawns.get(Mooshroom.NETWORK_ID), maxSpawns.get(Mule.NETWORK_ID), 
                maxSpawns.get(Ocelot.NETWORK_ID),maxSpawns.get(Pig.NETWORK_ID), maxSpawns.get(PigZombie.NETWORK_ID),
                ...
                maxSpawns.get(Spider.NETWORK_ID), maxSpawns.get(Wolf.NETWORK_ID),
